    ...
    ottr::TestCase$new(
      ...
      code = {
        ...
        testthat::expect_true(question.correct,
                                    info = "mean.age.control.group doesn't look right.")
      }
    ),
    ottr::TestCase$new(
      hidden = FALSE,
      ...
      code = {
        ...
        testthat::expect_true(question.correct,
                                    info = "mean.age.neighbors.group doesn't look right.")
      }
    ),
    ottr::TestCase$new(
      hidden = FALSE,
      ...
      code = {
        ...
        testthat::expect_true(question.correct,
                                    info = "This is the mean difference of age between the treatment and control group")
      }
    )
  )
)