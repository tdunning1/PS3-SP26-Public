    ...
    ottr::TestCase$new(
      ...
      code = {
        ...
        question.correct <- identical( q2$coefficients , 
            ...
            identical( q2$coefficients , 
                                      summary(lm(dem_us_house_percent_2020 ~ 
                                                       clinton_percent_2016 +
                   dem_us_house_percent_2018 + spending_rep_ushouse_2020, republicans.test))$coefficients ) |
            identical( q2$coefficients , 
                                      summary(lm(dem_us_house_percent_2020 ~ 
                                                       clinton_percent_2016 +
                   spending_rep_ushouse_2020 + dem_us_house_percent_2018, republicans.test))$coefficients ) |
            identical( q2$coefficients , 
                                      summary(lm(dem_us_house_percent_2020 ~ 
                                                       dem_us_house_percent_2018 +
                    clinton_percent_2016 + spending_rep_ushouse_2020, republicans.test))$coefficients ) |
            identical( q2$coefficients , 
                                      summary(lm(dem_us_house_percent_2020 ~ 
                                                       dem_us_house_percent_2018 +
                   spending_rep_ushouse_2020 + clinton_percent_2016, republicans.test))$coefficients )
